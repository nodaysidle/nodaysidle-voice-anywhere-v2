...
/**
 * Android Keystore-backed storage for the OpenRouter API key used for cloud STT.
 * Blank key means system/FUTO STT — never crash.
 */
object OpenRouterKeyStore {
    private const val PREFS = "voice_anywhere"
    private const val ENCRYPTED_KEY = "openrouter_api_key_ciphertext"
    private const val IV_KEY = "openrouter_api_key_iv"
    private const val KEY_ALIAS = "voice_anywhere_openrouter_key"
